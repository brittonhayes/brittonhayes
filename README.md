...
- [5e-bits/5e-database](https://github.com/5e-bits/5e-database) ([v1.3.1](https://github.com/5e-bits/5e-database/releases/tag/v1.3.1), 1 day ago) - Database for the D&amp;D 5th Edition API
...
- [zschaffer/dvdgo](https://github.com/zschaffer/dvdgo) - Bouncing DVD logo in your terminal, thanks to Go (2 days ago)
- [charmbracelet/gum](https://github.com/charmbracelet/gum) - A tool for glamorous shell scripts 🎀 (2 days ago)
- [disgoorg/bot-template](https://github.com/disgoorg/bot-template) - Easy DisGo Bot Template (4 days ago)
