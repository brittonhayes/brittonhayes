...
- [5e-bits/5e-srd-api](https://github.com/5e-bits/5e-srd-api) ([v1.3.7](https://github.com/5e-bits/5e-srd-api/releases/tag/v1.3.7), 4 days ago) - REST API to access D&amp;D 5th Edition SRD database
- [5e-bits/5e-database](https://github.com/5e-bits/5e-database) ([v1.2.2](https://github.com/5e-bits/5e-database/releases/tag/v1.2.2), 4 days ago) - Database for the D&amp;D 5th Edition API
- [maaslalani/slides](https://github.com/maaslalani/slides) ([v0.8.0](https://github.com/maaslalani/slides/releases/tag/v0.8.0), 5 days ago) - Terminal based presentation tool
...
- [genjidb/genji](https://github.com/genjidb/genji) - Document-oriented, embedded SQL database (2 days ago)
- [gobridge/about-us](https://github.com/gobridge/about-us) - Building Bridges That Educate &amp; Empower Underrepresented Communities. (6 days ago)
