...
- [brittonhayes/pillager](https://github.com/brittonhayes/pillager) ([v0.8.1](https://github.com/brittonhayes/pillager/releases/tag/v0.8.1), 3 months ago) - Pillage filesystems for sensitive information with Go 🔍
...
- [k3rn31/gremlins](https://github.com/k3rn31/gremlins) - A mutation testing tool for Go. (today)
- [codydbentley/wails-vite-vue-the-works](https://github.com/codydbentley/wails-vite-vue-the-works) - A Wails template with Vite, Vue 3 TypeScript, Vuex, Vue Router, Sass, ESLint, and Prettier (today)
