...
- [5e-bits/5e-database](https://github.com/5e-bits/5e-database) ([v2.1.1](https://github.com/5e-bits/5e-database/releases/tag/v2.1.1), 1 day ago) - Database for the D&amp;D 5th Edition API
- [5e-bits/5e-srd-api](https://github.com/5e-bits/5e-srd-api) ([v2.5.3](https://github.com/5e-bits/5e-srd-api/releases/tag/v2.5.3), 6 days ago) - REST API to access D&amp;D 5th Edition SRD database
...
- [Londek/reactea](https://github.com/Londek/reactea) - Rather simple Bubbletea companion for handling hierarchy and support for lifting state up (3 days ago)
- [cdklabs/cdk-nag](https://github.com/cdklabs/cdk-nag) - Check CDK applications for best practices using a combination of available rule packs (3 days ago)
