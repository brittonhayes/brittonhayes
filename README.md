...
- [5e-bits/5e-srd-api](https://github.com/5e-bits/5e-srd-api) ([v2.8.0](https://github.com/5e-bits/5e-srd-api/releases/tag/v2.8.0), 2 days ago) - REST API to access D&amp;D 5th Edition SRD database
- [5e-bits/5e-database](https://github.com/5e-bits/5e-database) ([v2.3.7](https://github.com/5e-bits/5e-database/releases/tag/v2.3.7), 2 days ago) - Database for the D&amp;D 5th Edition API
