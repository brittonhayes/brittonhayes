...
- [brittonhayes/roll](https://github.com/brittonhayes/roll) - A simple Go package and CLI for dice rolling 🎲 (3 days ago)
...
- [brittonhayes/roll](https://github.com/brittonhayes/roll) ([v0.2.1](https://github.com/brittonhayes/roll/releases/tag/v0.2.1), 2 days ago) - A simple Go package and CLI for dice rolling 🎲
- [5e-bits/5e-database](https://github.com/5e-bits/5e-database) ([v1.2.3](https://github.com/5e-bits/5e-database/releases/tag/v1.2.3), 2 weeks ago) - Database for the D&amp;D 5th Edition API
...
- [feat: terminal user interface added](https://github.com/brittonhayes/roll/pull/3) on [brittonhayes/roll](https://github.com/brittonhayes/roll) (2 days ago)
- [feat: improved random number generation and log output](https://github.com/brittonhayes/roll/pull/2) on [brittonhayes/roll](https://github.com/brittonhayes/roll) (6 days ago)
...
- [chelnak/gh-changelog](https://github.com/chelnak/gh-changelog) - A gh cli extension that will make your changelogs ✨ (1 day ago)
- [BetaPictoris/dict](https://github.com/BetaPictoris/dict) - 📔 View the dictionary through the CLI (1 day ago)
- [ecshreve/roll](https://github.com/ecshreve/roll) - A simple Go package and CLI for dice rolling 🎲 (5 days ago)
- [release-lab/install](https://github.com/release-lab/install) - install script for any command line tools (6 days ago)
