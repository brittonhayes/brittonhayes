...
- [5e-bits/5e-database](https://github.com/5e-bits/5e-database) ([v1.2.3](https://github.com/5e-bits/5e-database/releases/tag/v1.2.3), 6 days ago) - Database for the D&amp;D 5th Edition API
...
- [microsoft/ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners) - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all (3 days ago)
- [aseprite/api](https://github.com/aseprite/api) - Scripting API for Aseprite (3 days ago)
