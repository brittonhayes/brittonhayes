...
- [5e-bits/5e-database](https://github.com/5e-bits/5e-database) ([v1.1.0](https://github.com/5e-bits/5e-database/releases/tag/v1.1.0), 1 day ago) - Database for the D&amp;D 5th Edition API
...
- [5e-bits/5e-srd-api](https://github.com/5e-bits/5e-srd-api) ([v1.0.4](https://github.com/5e-bits/5e-srd-api/releases/tag/v1.0.4), 3 days ago) - REST API to access D&amp;D 5th Edition SRD database
